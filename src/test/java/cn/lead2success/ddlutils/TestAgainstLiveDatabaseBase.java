...
import cn.lead2success.ddlutils.io.BinaryObjectsHelper;
import cn.lead2success.ddlutils.io.DataReader;
import cn.lead2success.ddlutils.io.DataToDatabaseSink;
import cn.lead2success.ddlutils.io.DatabaseIO;
import cn.lead2success.ddlutils.platform.CreationParameters;
import cn.lead2success.ddlutils.platform.DefaultValueHelper;
...
public abstract class TestAgainstLiveDatabaseBase extends TestPlatformBase
{
    ...
    protected CreationParameters getTableCreationParameters(Database model)
    {
        ...
        for (Iterator<Entry<Object, Object>> entryIt = _testProps.entrySet().iterator(); entryIt.hasNext();)
        {
