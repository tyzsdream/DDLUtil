...
public class TestMisc extends TestAgainstLiveDatabaseBase
{
    ...
    /**
	 * Tests the backup and restore of a table with an identity column and a foreign
	 * key to it when identity override is turned on.
	 *
	 * @throws Exception
	 *             the exception
	 */
    ...
    /**
	 * Tests the backup and restore of a table with an identity column and a foreign
	 * key to it when identity override is turned off.
	 *
	 * @throws Exception
	 *             the exception
	 */
    ...
    /**
	 * Tests the backup and restore of a table with an identity column and a foreign
	 * key to itself while identity override is off.
	 *
	 * @throws Exception
	 *             the exception
	 */
    ...
    /**
	 * Tests the backup and restore of a self-referencing data set (with multiple
    ...
    /**
	 * Tests the backup and restore of several tables with complex relationships
	 * with an identity column and a foreign key to itself while identity override
	 * is off.
	 *
	 * @throws Exception
	 *             the exception
    ...
    public void testComplexTableModel() throws Exception
    {
        ...
        HashSet<String> expectedValues = new HashSet<>(Arrays.asList(new String[] { "1", "2" }));
