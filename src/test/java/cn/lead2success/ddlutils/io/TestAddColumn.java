...
import cn.lead2success.ddlutils.TestAgainstLiveDatabaseBase;
...
public class TestAddColumn extends TestAgainstLiveDatabaseBase {
	...
	public void testAddAutoIncrementColumn() {
		...
		// we need special catering for Sybase which does not support identity for
		// INTEGER columns
		final String model1Xml = "<?xml version='1.0' encoding='ISO-8859-1'?>\n" + "<database xmlns='"
				+ DatabaseIO.DDLUTILS_NAMESPACE + "' name='roundtriptest'>\n" + "  <table name='roundtrip'>\n"
				+ "    <column name='pk' type='INTEGER' primaryKey='true' required='true'/>\n" + "  </table>\n"
	...
	/**
	 * Tests the addition of multiple columns into the primary key which has an auto
	 * increment column.
	 */
	...
	/**
	 * Tests the addition of multiple columns including one with auto increment into
	 * the primary key.
	 */
	...
	/**
	 * Tests the addition of a non-unique index and a required auto increment
	 * column.
	 */
	...
	/**
	 * Tests the addition of a non-unique index and a required column with a default
	 * value.
	 */
	...
	/**
	 * Tests the addition of an unique index and a required column with a default
	 * value.
	 */
	...
	/**
	 * Tests the addition of a required auto increment column into a non-unique
	 * index.
	 */
	...
	/**
	 * Tests the addition of a required column with a default value into a
	 * non-unique index.
	 */
	...
	/**
	 * Tests the addition of a required column with a default value into an unique
	 * index.
	 */
	...
	/**
	 * Tests the addition of a foreign key and its local column with a default
	 * value.
	 */
	...
	/**
	 * Tests the addition of a foreign key and its local required auto increment
	 * column.
	 */
	...
	/**
	 * Tests the addition of a foreign key and its local required column with a
	 * default value.
	 */
	...
	public void testAddFKAndForeignColumn() {
		...
		createDatabase(model1Xml);
		// no point trying this with data in the db as it will only cause a constraint
		// violation
		alterDatabase(model2Xml);
	...
	/**
	 * Tests the addition of local and foreign auto increment columns into a foreign
	 * key.
	 */
	...
	/**
	 * Tests the addition of local and foreign columns with default values into a
	 * foreign key.
	 */
	...
	/**
	 * Tests the addition of local and foreign required auto increment columns into
	 * a foreign key.
	 */
	...
	/**
	 * Tests the addition of local and foreign required columns with default values
	 * into a foreign key.
	 */
