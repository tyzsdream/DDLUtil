...
public class TestDatabaseIO extends TestCase
{
    ...
    /**
	 * Tests a database model with an index with an index column that references an
	 * undefined column.
	 *
	 * @throws Exception
	 *             the exception
    ...
    /**
	 * Tests a database model with an unique index with an index column that
    ...
    /**
	 * Tests a database model with an unique index with an index column that has no
	 * name.
	 *
	 * @throws Exception
	 *             the exception
    ...
    /**
	 * Tests a complex database model with multiple tables, foreign keys, indices
	 * and uniques.
	 *
	 * @throws Exception
	 *             the exception
