...
/**
 * Tests the {@link DataReader} and {@link DataWriter} classes.
 * 
...
public class TestDataReaderAndWriter extends TestCase
{
	 ...
	 * @param bean
	 *            The bean to write and read back
	 * @param encoding
	 *            The encoding to use for the data xml
	 * @param expectedDataXml
	 *            The expected xml generated for the bean
    ...
    /**
	 * Tests reading the data from a file via the {#link
	 * {@link DataReader#read(String)} method.
	 *
	 * @throws Exception
	 *             the exception
	 */
    ...
    /**
	 * Tests reading the data from a file via the {#link
	 * {@link DataReader#read(File)} method.
	 *
	 * @throws Exception
	 *             the exception
	 */
    ...
    /**
	 * Tests reading the data from a file via the {#link
	 * {@link DataReader#read(java.io.InputStream)} method.
	 *
	 * @throws Exception
	 *             the exception
	 */
    ...
    /**
	 * Tests the reader & writer behavior when the table name is not a valid XML
	 * identifier.
	 *
	 * @throws Exception
	 *             the exception
    ...
    /**
	 * Tests the reader & writer behavior when the table name contains a '&'
	 * character.
	 *
	 * @throws Exception
	 *             the exception
    ...
    /**
	 * Tests the reader & writer behavior when the table name contains characters
	 * not allowed in XML.
	 *
	 * @throws Exception
	 *             the exception
    ...
    /**
	 * Tests the reader & writer behavior when a column name is not a valid XML
	 * identifier.
	 *
	 * @throws Exception
	 *             the exception
    ...
    /**
	 * Tests the reader & writer behavior when a column name is not a valid tag, and
	 * the column name is shorter than 255 characters and the value is longer.
	 *
	 * @throws Exception
	 *             the exception
	 */
    ...
    /**
	 * Tests the reader & writer behavior when a column name is a valid tag, and the
	 * column name is longer than 255 characters and the value is shorter.
	 *
	 * @throws Exception
	 *             the exception
	 */
    ...
    /**
	 * Tests the reader & writer behavior when a column name is a valid tag, and
	 * both the column name and value are longer than 255 characters.
	 *
	 * @throws Exception
	 *             the exception
	 */
    ...
    /**
	 * Tests the reader & writer behavior when a column name is not a valid tag, and
	 * the value is invalid, and both are short.
	 *
	 * @throws Exception
	 *             the exception
	 */
    ...
    /**
	 * Tests the reader & writer behavior when a column name is a valid tag and
	 * longer, than 255 characters, and the value is invalid and shorter than 255
	 * characters.
	 *
	 * @throws Exception
	 *             the exception
    ...
    /**
	 * Tests the reader & writer behavior when a column name contains an invalid
	 * character.
	 *
	 * @throws Exception
	 *             the exception
    ...
    /**
	 * Tests the reader & writer behavior when a column value contains an invalid
	 * character.
	 *
	 * @throws Exception
	 *             the exception
    ...
    /**
	 * Tests the reader & writer behavior when a column value contains the '&'
	 * character.
	 *
	 * @throws Exception
	 *             the exception
