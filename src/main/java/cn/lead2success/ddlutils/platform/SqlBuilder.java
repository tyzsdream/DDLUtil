        ...
        if (!tableName.endsWith("_")) {
            ...
            for (Column column : columns) {
                ...
                if (StringUtils.isNotBlank(description)) {
                    print("COMMENT ON COLUMN " + tableName + "." + columnName + " IS '" + description + "'");
                    println(getPlatformInfo().getSqlCommandDelimiter());
                }
            }
        }
