...
public class JdbcModelReader {
     ...
     * @param name       The name of the resulting database; <code>null</code> when the
     ...
     *                   default name (the catalog) is desired which might be
     *                   <code>null</code> itself though
     * @param catalog    The catalog to acess in the database; use <code>null</code> for
     *                   the default value
     * @param schema     The schema to acess in the database; use <code>null</code> for the
     *                   default value
     * @param tableTypes The table types to process; use <code>null</code> or an empty list
     ...
     * @param catalog       The catalog to acess in the database; use <code>null</code> for
     *                      the default value
     * @param schemaPattern The schema(s) to acess in the database; use <code>null</code> for
     *                      the default value
     * @param tableTypes    The table types to process; use <code>null</code> or an empty list
     *                      for the default ones
     * @return The tables
     ...
     * @param values   The table metadata values as defined by
     ...
     * @param metaData The database meta data
     * @param values   The column meta data values as defined by
     ...
     * @param metaData The database meta data
     * @param values   The primary key meta data values as defined by
     ...
     * @param paramSearchStringPattern the search string pattern
     */
