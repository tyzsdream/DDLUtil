...
public interface Platform {
     ...
     * @param continueOnError Whether to continue executing the sql commands when an error
     *                        occurred
     ...
     * @param parameters          Additional parameters relevant to database creation (which are
     *                            platform specific)
     * @throws DatabaseOperationException    the database operation exception
     ...
     * @param continueOnError Whether to continue with the next sql statement when an error
     *                        occurred
     * @throws DatabaseOperationException the database operation exception
     ...
     *                        use <code>null</code> for the platform-specific default value
     * @param tableTypes      The table types to read from the existing database; use
